...
# collect_submodules('mido') ensures mido.midifiles, mido.messages, etc.
# are all bundled — hiddenimports=['mido'] alone only gets the top-level init.
...
a = Analysis(
    ...
    binaries=[],
    datas=_mido_datas,
    hiddenimports=['keyboard'] + _mido_hidden,
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[
